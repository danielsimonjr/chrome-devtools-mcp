...
export class DeviceModeModel extends Common.ObjectWrapper.ObjectWrapper {
    ...
    calculateAndEmulate(resetPageScaleFactor) {
        ...
        if (this.#type === Type.Device && this.#device && this.#mode) {
            ...
            this.applyDeviceMetrics(new Geometry.Size(screenWidth, screenHeight), new Insets(0, 0, 0, 0), this.#scaleSetting.get(), this.#deviceScaleFactorSetting.get() || defaultDeviceScaleFactor, mobile, screenHeight >= screenWidth ? "portraitPrimary" /* Protocol.Emulation.ScreenOrientationType.PortraitPrimary */ :
