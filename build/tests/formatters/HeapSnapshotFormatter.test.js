...
describe('HeapSnapshotFormatter', () => {
    ...
    describe('formatRetainingPaths', () => {
        it('formats retaining paths correctly', () => {
            ...
            const result = HeapSnapshotFormatter.formatRetainingPaths(mockRetainingPaths);
            const expected = [
    ...
    describe('formatRetainedByContextSummary', () => {
        it('formats retained by context summary correctly', () => {
            ...
            const result = HeapSnapshotFormatter.formatRetainedByContextSummary(mockSummary);
            const expected = [
                'Context count: 2',
...
//# sourceMappingURL=HeapSnapshotFormatter.test.js.map