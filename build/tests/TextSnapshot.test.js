...
describe('TextSnapshot', () => {
    ...
    it('inserts extraHandles into the snapshot correctly', async () => {
      ...
      `);
            ...
            assert.ok(!foundMiddleBefore, 'Middle element should NOT be in the snapshot when not passed as extra handle');
            ...
            assert.strictEqual(extraNode.role, 'div', 'Extra node should have role "div"');
            ...
            assert.ok(foundChild, 'Child node should be moved to extra node children');
            ...
            assert.ok(!foundChildInParent, 'Child node should NOT be in parent children');
            ...
            assert.ok(foundMiddleInParent, 'Middle node should be in parent children');
        });
    });
});
//# sourceMappingURL=TextSnapshot.test.js.map